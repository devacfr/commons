...
public interface IPathMatcher {
    ...
    /**
     * Match the given <code>path</code> against the corresponding part of the given <code>pattern</code>, according to
     ...
     * <p>
     * This method is supposed to find out which part of the path is matched dynamically through an actual pattern, that
     * is, it strips off a statically defined leading path from the given full path, returning only the actually
     * pattern-matched part of the path.
     * <p>
     * For example: For "myroot/*.html" as pattern and "myroot/myfile.html" as full path, this method should return
     * "myfile.html". The detailed determination rules are specified to this PathMatcher's matching strategy.
     * <p>
     * A simple implementation may return the given full path as-is in case of an actual pattern, and the empty String
